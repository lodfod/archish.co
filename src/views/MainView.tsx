            ...
            <div className='pt-2 flex flex-col sm:flex-row justify-center items-center '>
                <div>
                    <div className='h-36 w-36 pt-5 flex justify-center'>
                        <img className=" h-fit  align-middle grayscale hover:grayscale-0" src="/src/assets/archish_flamingo.png" alt="" />
                    </div>
                ...
                <div>
                    <div className='h-36 w-36 flex justify-center align-middle'>
                        <img className=" h-36 grayscale hover:grayscale-0" src="/src/assets/archish_keyboard.png" alt="" />
                    </div>
                ...
                <div>
                    <div className='h-44 w-44 flex justify-center align-middle'>
                        <img className="h-fit grayscale hover:grayscale-0 pt-6" src="/src/assets/archish_52prime.png" alt="" />
                    </div>
